...
<div class="dropdown-menu dropdown-menu-right" aria-labelledby="userDropdown">
  ...
  Subscriptions</a>
  <a class="dropdown-item" href="#l"><i class="fas fa-fw fa-cog"></i> &nbsp; Settings</a>
  <div class="dropdown-divider"></div>
            ...
            <div class="col-md-8">
               <div class="single-video-left">
                  <div class="single-video">
                     <video width="100%" height="315%" src="../vid/film8.mp4" frameborder="5" controls></video>
                 </div>
                 <div class="single-video-title box mb-3">
                     <h2><a href="#">Clownery </a><span title="" data-placement="top"
                    ...
                    <div class="single-video-info-content box mb-3">
                        ...
                        <p>Horror</p>
                        <h6>Synopsis</h6>
                        <p>After a terrible trauma on her birthday, Emma chooses not to celebrate it again. But when she turns 21,
						a friend of her breaks the ritual with a surprise party, unaware of awakening horrors, 
						which for years have been waiting in the darkness.</p>
                        <h6>Kualitas</h6>
                        <p>Blueray</p>
                        <h6>Diterbitkan</h6>
                        <p>ArJ Movie </p>
...
<div class="video-card video-card-list">
  ...
  <div class="video-title">
      <a href="Film6.html">Superman Red Son 2020</a>
  </div>
  <div class="video-page text-success">
...
<div class="video-card video-card-list">
   ...
   <div class="video-title">
       <a href="Film7.html">The Dawn 2019</a>
   </div>
   <div class="video-page text-success">
      Blueray Available <a title="" data-placement="top" data-toggle="tooltip" href="#"
      data-original-title="Verified"><i
