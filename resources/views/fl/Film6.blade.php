...
<div id="content-wrapper">
            ...
            <div class="col-md-8">
               <div class="single-video-left">
                  <div class="single-video">
                     <video width="100%" height="315%" src="../vid/film6.mp4" frameborder="5" controls></video>
                 </div>
                 <div class="single-video-title box mb-3">
                     <h2><a href="#">Superman Red Son 2020 </a><span title="" data-placement="top"
                    ...
                    <div class="single-video-info-content box mb-3">
                        ...
                        <p>Action</p>
                        <h6>Synopsis</h6>
                        <p>In the Soviet Union during the year 1946, a young boy is chased by a gang of bullies. A young girl, Svetlana, defends him by chasing them away. He reveals to her that he was not scared for his own safety but that of the bullies before demonstrating superhuman strength and the ability to fly. Svetlana tells the boy he can use his powers to help the country should he so choose.

						A decade later, in the year 1955, 
					the Soviet Union releases a 
									propaganda film of an alien superhuman under the command of Joseph Stalin, whom the American media dubs the "Soviet Superman". United States President Eisenhower tasks Lex Luthor to develop a countermeasure against the superhuman. Meanwhile, Superman prevents a satellite from crashing into Metropolis, which leads to Lex's wife Lois Lane securing an interview with him. She shows him a top secret document that leads Superman to a secret gulag where he finds a dying Svetlana, who was imprisoned there because she knew his real identity. Enraged, Superman confronts Stalin about the gulag and incinerates him with his heat vision. As a result, 
									Superman becomes the new leader of the Soviet Union, pledging to use his powers for good and to spread the influence of the Soviet state.</p>
                        <h6>Kualitas</h6>
                        <p>Blueray</p>
                        <h6>Diterbitkan</h6>
                        <p>ArJ Movie </p>
         ...
         <div class="col-md-12">
            <div class="video-card video-card-list">
              ...
              <div class="video-page text-danger">
                Trailer Available <a title="" data-placement="top" data-toggle="tooltip" href="#"
                data-original-title="Cooming Soon"><i class="fas fa-frown text-danger"></i></a>
            </div>
  ...
  <div class="video-card video-card-list">
   <div class="video-card-image">
      <a class="play-icon" href="#"><i class="fas fa-play-circle"></i></a>
      <a href="#"><img class="../img-fluid" src="../img/film3.jpg" alt=""></a>
      <div class="time">60:00</div>
  </div>

  <div class="video-title">
      <a href="Film3.html">Frozen II</a>
  </div>
  <div class="video-page text-success">
      Bluray Available <a title="" data-placement="top" data-toggle="tooltip" href="#"
      data-original-title="Verified"><i
