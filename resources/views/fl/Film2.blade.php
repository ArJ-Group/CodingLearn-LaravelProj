    ...
    <div class="col-md-8">
     <div class="single-video-left">
      <div class="single-video">
       <video width="100%" height="315%" src="../vid/film2.mp4" frameborder="5" controls></video>
     </div>
     <div class="single-video-title box mb-3">
       <h2><a href="#">Avangers Infinity War </a><span title="" data-placement="top"
      ...
      <div class="single-video-info-content box mb-3">
        ...
        Everything the Avengers have fought for has led up to this moment, the fate of Earth and existence has never been more uncertain</p>
        <h6>Kualitas</h6>
        <p>Blueray</p>
        <h6>Diterbitkan</h6>
        <p>ArJ Movie </p>
