...
<p class="first admonition-title">The SQL CREATE DATABASE Statement </p>
...
<div class="highlight-ci"><div class="highlight"><pre><span></span>
   <span class="sqlkeywordcolor" style="color:mediumblue">CREATE</span> <span class="sqlkeywordcolor" style="color:mediumblue">DATABASE</span> DBSchool;<span class="sqlnumbercolor" style="color:">
   </div>
