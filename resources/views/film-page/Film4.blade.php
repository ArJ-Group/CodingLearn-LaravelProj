            ...
            <div class="col-md-8">
               <div class="single-video-left">
                  <div class="single-video">
                     <video width="100%" height="315%" src="../vid/film4.mp4" frameborder="5" controls></video>
                 </div>
                 <div class="single-video-title box mb-3">
                     <h2><a href="#">Maleficent: Mistress of Evil </a><span title="" data-placement="top"
                    ...
                    <div class="single-video-info-content box mb-3">
                        ...
                        <p>Action</p>
                        <h6>Synopsis</h6>
                        <p>Mistress of Evil is an American epic dark fantasy film released on October 18, 2019. As the official sequel to Maleficent, 
						Angelina Jolie returns to portray the titular role of the same name, along with Elle Fanning as Princess Aurora .</p>
                        <h6>Kualitas</h6>
                        <p>Blueray</p>
                        <h6>Diterbitkan</h6>
                        <p>ArJ Movie </p>
