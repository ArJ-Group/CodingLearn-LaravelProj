    ...
    <div class="col-md-8">
     ...
     <div class="single-video-title box mb-3">
      ...
      <div class="single-video-info-content box mb-3">
        ...
        <h6>Synopsis</h6>
        <p>The SpongeBob Movie: Sponge on the Run is a movie starring Tim Hill, Clancy Brown, and Bill Fagerbakke. After SpongeBob's beloved pet snail Gary is snail-napped, he and Patrick embark on an epic adventure to The Lost City</p>
        <h6>Kualitas</h6>
        <p>Blueray</p>
        <h6>Diterbitkan</h6>
        <p>ArJ Movie </p>
...
<div class="video-title">
  <a href="Film2.html">Avenger End Game</a>
</div>
