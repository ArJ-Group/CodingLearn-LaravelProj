    ...
    <div class="wy-grid-for-nav">
      ...
      <nav data-toggle="wy-nav-shift" class="wy-nav-side">
        ...
        <div class="wy-menu wy-menu-vertical" data-spy="affix" role="navigation" aria-label="main navigation">
          ...
          <ul class="current">
            <li class="current toctree-l1"><a class="current reference internal" href="{{url('js.jsdom')}}">Java Script HTML DOM</a>
              <ul>
                <li class="current toctree-l2"><a class="current reference internal" href="#">Java Script DOM Intro</a></li>
                <li class="toctree-l2"><a class="reference internal" href="#">Java Script DOM Method</a></li>
                <li class="toctree-l2"><a class="reference internal" href="#">Java Script DOM Document</a></li>
                <li class="toctree-l2"><a class="reference internal" href="#">Java Script DOM Elements</a></li>
                <li class="toctree-l2"><a class="reference internal" href="#">Java Script DOM HTML</a></li>
            ...
            <div role="main" class="document">
              <div class="section" id="welcome-to-codeigniter">
                ...
                <p>When a web page is loaded, the browser creates a <strong>D</strong>ocument
                  <strong>O</strong>bject <strong>M</strong>odel of the page.
                </p>
                ...
                <div class="w3-example">
                  ...
                  <div class="w3-padding w3-white w3-center w3-margin-bottom notranslate">
                    <img style="max-width:100%" src="https://www.w3schools.com/js/pic_htmltree.gif" alt="DOM HTML tree">
                  </div>
                </div>
