    ...
    <div class="wy-grid-for-nav">
      ...
      <nav data-toggle="wy-nav-shift" class="wy-nav-side">
        ...
        <div class="wy-menu wy-menu-vertical" data-spy="affix" role="navigation" aria-label="main navigation">
          ...
          <ul class="current">
            <li class="current toctree-l1"><a class="current reference internal" href="{{url('pyt.pytexer')}}">Python Exercise</a>
              <ul>
                <li class="current toctree-l2"><a class="current reference internal" href="#">Python Exercise</a></li>
