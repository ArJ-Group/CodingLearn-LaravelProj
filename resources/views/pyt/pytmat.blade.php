    ...
    <div class="wy-grid-for-nav">
      ...
      <nav data-toggle="wy-nav-shift" class="wy-nav-side">
        ...
        <div class="wy-menu wy-menu-vertical" data-spy="affix" role="navigation" aria-label="main navigation">
          ...
          <ul class="current">
            <li class="current toctree-l1"><a class="current reference internal" href="{{url('pyt.pytmat')}}">Python Matplotlib</a>
              <ul>
                <li class="current toctree-l2 "><a class="current reference internal" href="{{url('pyt.pytmat')}}">Python Get Started</a></li>
                <li class="toctree-l2"><a class="reference internal" href="#">Python Pyplot</a></li>
                <li class="toctree-l2"><a class="reference internal" href="#">Python Plotting</a></li>
                <li class="toctree-l2"><a class="reference internal" href="#">Python Markers</a></li>
                <li class="toctree-l2"><a class="reference internal" href="#">Python Line</a></li>
...
<p>If you have <a href="/python/default.asp">Python</a> and <a href="python_pip.asp">PIP</a> already installed on a system, then installation of 
Matplotlib is very easy.</p>
...
C:\Users\<em>Your Name</em>&gt;pip install matplotlib</div>
</div>

<p>If this command fails, then use a python distribution that already has Matplotlib installed,&nbsp; like Anaconda, Spyder etc.</p>
<hr>

<h2>Import Matplotlib  </h2>
<p>Once Matplotlib is installed, import it in your applications by adding the
<code class="w3-codespan">import <i>module</i></code> statement:</p>

<div class="w3-example" bis_skin_checked="1">
<div class="w3-code notranslate pythonHigh" bis_skin_checked="1"><span class="pythoncolor" style="color:black">
<span class="pythonkeywordcolor" style="color:mediumblue">import</span> matplotlib
 </span></div>
</div>

<p>Now Matplotlib is imported and ready to use:</p>
<hr>

<h2>Checking Matplotlib Version</h2>

<p>The version string is stored under <code class="w3-codespan">__version__</code> 
attribute.</p>

<div class="w3-example" bis_skin_checked="1">
<h3>Example</h3>
<div class="w3-code notranslate pythonHigh" bis_skin_checked="1"><span class="pythoncolor" style="color:black"><span class="pythonnumbercolor" style="color:red">
</span>  <span class="pythonkeywordcolor" style="color:mediumblue">import</span> matplotlib<br><br><span class="pythonkeywordcolor" style="color:mediumblue">print</span>(matplotlib.__version__)<span class="pythonnumbercolor" style="color:red">
</span> </span></div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="trypython.asp?filename=demo_matplotlib_version">Try it Yourself »</a>
</div>

<div class="w3-panel w3-note" bis_skin_checked="1">
  <p><strong>Note:</strong> two underscore characters are used in <code class="w3-codespan">__version__</code>.</p>
</div>
