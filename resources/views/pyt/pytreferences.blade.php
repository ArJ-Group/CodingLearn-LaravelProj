    ...
    <div class="wy-grid-for-nav">
      ...
      <nav data-toggle="wy-nav-shift" class="wy-nav-side">
        ...
        <div class="wy-menu wy-menu-vertical" data-spy="affix" role="navigation" aria-label="main navigation">
          ...
          <ul class="current">
            <li class="current toctree-l1"><a class="current reference internal" href="{{url('pyt.pytreferences')}}">Python References</a>
              <ul>
                <li class="current toctree-l2"><a class="current reference internal" href="#">Python Overview</a></li>
                <li class="toctree-l2"><a class="reference internal" href="#">Python Built-in Functions</a></li>
                <li class="toctree-l2"><a class="reference internal" href="#">Python String Methods</a></li>
                <li class="toctree-l2"><a class="reference internal" href="#">Python List Methods</a></li>
                <li class="toctree-l2"><a class="reference internal" href="#">Python Dictionary Methods</a></li>
        ...
        <div class="wy-nav-content">
          <div class="rst-content">
            ...
            <div role="main" class="document">
              ...
              <div class="refcont" bis_skin_checked="1">
                ...
                <a class="bigbtn" href="python_ref_file.asp">File Methods</a>
                <a class="bigbtn" href="python_ref_keywords.asp">Keywords</a>
                <a class="bigbtn" href="python_ref_exceptions.asp">Exceptions</a>
                <a class="bigbtn" href="python_ref_glossary.asp">Glossary</a>
              </div>
              <br>
              ...
              <div class="refcont" bis_skin_checked="1">
                <a class="bigbtn" href="module_random.asp">Random Module</a>
                <a class="bigbtn" href="module_requests.asp">Requests Module</a>
                <a class="bigbtn" href="module_math.asp">Math Module</a>
                <a class="bigbtn" href="module_cmath.asp">CMath Module</a>
              </div>
              <br><br><br>
