      ...
      <nav data-toggle="wy-nav-shift" class="wy-nav-side">
        ...
        <div class="wy-menu wy-menu-vertical" data-spy="affix" role="navigation" aria-label="main navigation">
          ...
          <ul class="current">
            <li class=" current toctree-l1"><a class="current reference internal" href="{{url('pyt.pytfile')}}">Python FIle handling</a>
              <ul>
                <li class="current toctree-l2"><a class="current eference internal" href="#">Python File Handling</a></li>
                <li class="toctree-l2"><a class="reference internal" href="#">Python Read Files</a></li>
                <li class="toctree-l2"><a class="reference internal" href="#">Python Create/Write Files</a></li>
                <li class="toctree-l2"><a class="reference internal" href="#">Python Delete Files</a></li>
...
f = <span class="pythonkeywordcolor" style="color:mediumblue">open</span>(<span class="pythonstringcolor" style="color:brown">"demofile.txt"</span>)<span class="pythonnumbercolor" style="color:red">
</span> </span></div>
</div>
...
<div class="w3-example" bis_skin_checked="1">
<div class="w3-code notranslate pythonHigh" bis_skin_checked="1"><span class="pythoncolor" style="color:black">
f = <span class="pythonkeywordcolor" style="color:mediumblue">open</span>(<span class="pythonstringcolor" style="color:brown">"demofile.txt"</span>, <span class="pythonstringcolor" style="color:brown">"rt"</span>)<span class="pythonnumbercolor" style="color:red">
</span> </span></div>
</div>
