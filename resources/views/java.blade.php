                     ...
                     <div class="furniture-right">
                        ...
                        <div class="right-list-f">
                           <ul>
                              ...
                              <li><a href="{{url('html.htmlform')}}"><img width="32" src="a/images/b.png" alt="" /> Learn Icons</a></li>
                              <li><a href="{{url('html.htmlgrapic')}}"><img width="32" src="a/images/b.png" alt="" /> Learn Graphics</a></li>
                              <li><a href="{{url('html.htmlmedia')}}"><img width="32" src="a/images/b.png" alt="" /> Learn How To</a></li>
                              <li><a href="{{url('html.htmlreferences')}}"><img width="32" src="a/images/b.png" alt="" /> Learn Sass</a></li>
                              <li><a href="{{url('html.htmltutor')}}"><img width="32" src="a/images/b.png" alt="" /> Exercise</a></li>
                           </ul>
                        </div>
                     </div>
                  </div>
