               ...
               <div class="col-md-8 col-sm-12">
                  <div class="right-nav">
                     ...
                     <div class="nav-b hidden-xs">
                        <div class="nav-box">
                           <ul>
                              <li><a href="howitworks.java">Tutorial</a></li>
                              <li><a href="productpage.java">References</a></li>
                           </ul>
                        </div>
                     </div>
                  </div>
      ...
      <div class="container">
         <div class="row">
            <div class="furniture-main">
               <h2 style="font-weight: bold;">Java Learn Application</h2>
               ...
               <div class="col-md-3 hidden-xs">
                  <div class="furniture-right">
                     ...
                     <div class="right-list-f">
                        <ul>
                           <li><a href="{{url('java.welcomejava')}}"><img width="32" src="a/images/b.png" alt="" /> What is Java?</a></li>
                           <li><a href="{{url('java.javatutor')}}"><img width="32" src="a/images/b.png" alt="#" /> Java introduce</a></li>
                           <li><a href="{{url('java.javamethod')}}"><img width="32" src="a/images/b.png" alt="#" /> Learn Java Method</a></li>
                           <li><a href="{{url('java.javaclasses')}}"><img width="32" src="a/images/b.png" alt="" /> Learn Java Classes</a></li>
                     ...
                     <div class="left-f-box">
                        <div class="col-sm-4">
                           ...
                           <ul>
                              ...
                              <li><a href="howitworks.java">How it works suppliers</a></li>
                              <li><a href="pricing.java">Pricing</a></li>
                        ...
                        <div class="col-sm-4">
                           <h2>COMPANY</h2>
                           <ul>
                              <li><a href="about-us.java">About chamb</a></li>
